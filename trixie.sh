...
pkg=(avahi-autoipd avahi-daemon bleachbit cron curl exfat-fuse gzip nano netcat-openbsd nfs-kernel-server nginx ntfs-3g openssh-server qbittorrent-nox rsync samba screen tar unzip wsdd2 xfsprogs)
